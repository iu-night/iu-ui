...
.iu-card {
  --i-apply:
    flex flex-col w-full text-16px rounded box-border break-words
...
.iu-card-bordered {
  --i-apply: b-1px b-[#efeff5] dark:b-[#fff] dark:b-opacity-10;
}
...
.iu-card-header {
  --i-apply: flex items-center px-20px py-10px text-20px font-500 box-border;
}

.iu-card-header-main {
  --i-apply: flex-1 items-center;
}

.iu-card-header-extra {
  --i-apply: flex items-center text-16px;
}

.iu-card-content {
  --i-apply: flex-1 px-20px py-10px box-border;
}
...
.iu-card-action {
  --i-apply: flex-1 px-20px py-10px box-border bg-[#efefef] dark:bg-[#252525];
}
</style>
